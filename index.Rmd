...
subtitle: "um estudo exploratório sobre as disparidades de gênero entre 2006 a 2018"
...
load("~/ABCP_2022/dados/lapop_abcp.RData")
load("~/ABCP_2022/dados/eseb_long_presidente.Rda")
load("~/ABCP_2022/dados/ideologia_2002_2020.Rda")
...
Um conjunto diferente de padrões de socialização experimentados por homens e mulheres podem influenciar de forma diferenciada os valores centrais, as orientações políticas, as atitudes e o comportamento.
--
...
Explorar as atitudes políticas e comportamentos eleitorais referentes ao grupo do sexo feminino em comparação com o sexo masculino entre 2002 até 2018.
...
- *Policy gap* - diferença nas preferências por políticas públicas 
     - Mulheres demonstram preferência por um grupo de política pública diferente do que apoiado por homens (Diekman; Schneider, 2010)
...
Por meio das análises bivariadas, pode-se considerar que existe uma relacão entre a variável gênero e as atitudes, ou seja, o gênero faz diferença nas atitudes aqui apresentadas, 
